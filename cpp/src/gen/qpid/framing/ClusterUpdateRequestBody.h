#ifndef QPID_FRAMING_CLUSTERUPDATEREQUESTBODY_H
#define QPID_FRAMING_CLUSTERUPDATEREQUESTBODY_H
/*
 *
...
public:
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.updateRequest(getUrl());
    }
...
#endif  /*!QPID_FRAMING_CLUSTERUPDATEREQUESTBODY_H*/
