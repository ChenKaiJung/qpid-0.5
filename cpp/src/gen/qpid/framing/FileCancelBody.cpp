...
#include "FileCancelBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void FileCancelBody::setConsumerTag(const string& _consumerTag) {
    consumerTag = _consumerTag;
    flags |= (1 << 8);
}
const string& FileCancelBody::getConsumerTag() const { return consumerTag; }
