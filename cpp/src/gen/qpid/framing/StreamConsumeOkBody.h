#ifndef QPID_FRAMING_STREAMCONSUMEOKBODY_H
#define QPID_FRAMING_STREAMCONSUMEOKBODY_H
/*
 *
...
class StreamConsumeOkBody : public ModelMethod {
    string consumerTag;
    uint16_t flags;
public:
    ...
    StreamConsumeOkBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
...
#endif  /*!QPID_FRAMING_STREAMCONSUMEOKBODY_H*/
