...
void ClusterConnectionDeliveryRecordBody::setQueue(const string& _queue) {
    queue = _queue;
    flags |= (1 << 8);
}
const string& ClusterConnectionDeliveryRecordBody::getQueue() const { return queue; }
...
void ClusterConnectionDeliveryRecordBody::setTag(const string& _tag) {
    tag = _tag;
    flags |= (1 << 10);
}
const string& ClusterConnectionDeliveryRecordBody::getTag() const { return tag; }
