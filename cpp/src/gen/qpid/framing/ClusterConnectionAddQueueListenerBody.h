#ifndef QPID_FRAMING_CLUSTERCONNECTIONADDQUEUELISTENERBODY_H
#define QPID_FRAMING_CLUSTERCONNECTIONADDQUEUELISTENERBODY_H
/*
 *
...
public:
    ...
    bool hasQueue() const;
    void clearQueueFlag();
    void setConsumer(uint32_t _consumer);
    uint32_t getConsumer() const;
    bool hasConsumer() const;
    void clearConsumerFlag();
    typedef void ResultType;

    template <class T> ResultType invoke(T& invocable) const {
        return invocable.addQueueListener(getQueue(), getConsumer());
    }
...
#endif  /*!QPID_FRAMING_CLUSTERCONNECTIONADDQUEUELISTENERBODY_H*/
