...
void ConnectionCloseBody::setReplyText(const string& _replyText) {
    replyText = _replyText;
    flags |= (1 << 9);
}
const string& ConnectionCloseBody::getReplyText() const { return replyText; }
