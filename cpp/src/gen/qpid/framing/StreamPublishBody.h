#ifndef QPID_FRAMING_STREAMPUBLISHBODY_H
#define QPID_FRAMING_STREAMPUBLISHBODY_H
/*
 *
...
public:
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.publish(getExchange(), getRoutingKey(), getMandatory(), getImmediate());
    }
...
#endif  /*!QPID_FRAMING_STREAMPUBLISHBODY_H*/
