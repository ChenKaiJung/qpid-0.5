#ifndef QPID_FRAMING_MESSAGESETFLOWMODEBODY_H
#define QPID_FRAMING_MESSAGESETFLOWMODEBODY_H
/*
 *
...
public:
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.setFlowMode(getDestination(), getFlowMode());
    }
...
#endif  /*!QPID_FRAMING_MESSAGESETFLOWMODEBODY_H*/
