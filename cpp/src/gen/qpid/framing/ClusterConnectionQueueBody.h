#ifndef QPID_FRAMING_CLUSTERCONNECTIONQUEUEBODY_H
#define QPID_FRAMING_CLUSTERCONNECTIONQUEUEBODY_H
/*
 *
...
public:
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.queue(getEncoded());
    }
...
#endif  /*!QPID_FRAMING_CLUSTERCONNECTIONQUEUEBODY_H*/
