...
#include "StreamConsumeOkBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void StreamConsumeOkBody::setConsumerTag(const string& _consumerTag) {
    consumerTag = _consumerTag;
    flags |= (1 << 8);
}
const string& StreamConsumeOkBody::getConsumerTag() const { return consumerTag; }
