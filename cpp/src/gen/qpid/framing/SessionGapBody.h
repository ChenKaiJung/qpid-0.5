#ifndef QPID_FRAMING_SESSIONGAPBODY_H
#define QPID_FRAMING_SESSIONGAPBODY_H
/*
 *
...
class SessionGapBody : public AMQMethodBody {
...
public:
    ...
    SessionGapBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
...
virtual uint8_t type() const { return 0;/*control segment*/ }
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.gap(getCommands());
    }
