#ifndef QPID_FRAMING_DTXROLLBACKBODY_H
#define QPID_FRAMING_DTXROLLBACKBODY_H
/*
 *
...
class DtxRollbackBody : public ModelMethod {
    Xid xid;
    uint16_t flags;
public:
    ...
    DtxRollbackBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.rollback(getXid());
    }
...
#endif  /*!QPID_FRAMING_DTXROLLBACKBODY_H*/
