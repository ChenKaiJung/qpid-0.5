#ifndef QPID_FRAMING_CONNECTIONOPENBODY_H
#define QPID_FRAMING_CONNECTIONOPENBODY_H
/*
 *
...
public:
    ...
    const string& getVirtualHost() const;
    bool hasVirtualHost() const;
    void clearVirtualHostFlag();
    void setCapabilities(const Array& _capabilities);
    const Array& getCapabilities() const;
    bool hasCapabilities() const;
    void clearCapabilitiesFlag();
    void setInsist(bool _insist);
    bool getInsist() const;
...
#endif  /*!QPID_FRAMING_CONNECTIONOPENBODY_H*/
