#ifndef QPID_FRAMING_DTXPREPAREBODY_H
#define QPID_FRAMING_DTXPREPAREBODY_H
/*
 *
...
class DtxPrepareBody : public ModelMethod {
    Xid xid;
    uint16_t flags;
public:
    ...
    DtxPrepareBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.prepare(getXid());
    }
...
#endif  /*!QPID_FRAMING_DTXPREPAREBODY_H*/
