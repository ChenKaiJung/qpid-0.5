#ifndef QPID_FRAMING_CLUSTERCONNECTIONQUEUEPOSITIONBODY_H
#define QPID_FRAMING_CLUSTERCONNECTIONQUEUEPOSITIONBODY_H
/*
 *
...
public:
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.queuePosition(getQueue(), getPosition());
    }
...
#endif  /*!QPID_FRAMING_CLUSTERCONNECTIONQUEUEPOSITIONBODY_H*/
