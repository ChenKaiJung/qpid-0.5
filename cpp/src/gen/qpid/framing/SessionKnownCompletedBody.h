#ifndef QPID_FRAMING_SESSIONKNOWNCOMPLETEDBODY_H
#define QPID_FRAMING_SESSIONKNOWNCOMPLETEDBODY_H
/*
 *
...
class SessionKnownCompletedBody : public AMQMethodBody {
...
public:
    ...
    SessionKnownCompletedBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
...
virtual uint8_t type() const { return 0;/*control segment*/ }
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.knownCompleted(getCommands());
    }
...
#endif  /*!QPID_FRAMING_SESSIONKNOWNCOMPLETEDBODY_H*/
