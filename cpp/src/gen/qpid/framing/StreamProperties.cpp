...
void StreamProperties::setContentType(const string& _contentType) {
    contentType = _contentType;
    flags |= (1 << 8);
}
const string& StreamProperties::getContentType() const { return contentType; }
bool StreamProperties::hasContentType() const { return flags & (1 << 8); }
void StreamProperties::clearContentTypeFlag() { flags &= ~(1 << 8); }

void StreamProperties::setContentEncoding(const string& _contentEncoding) {
    contentEncoding = _contentEncoding;
    flags |= (1 << 9);
}
const string& StreamProperties::getContentEncoding() const { return contentEncoding; }
