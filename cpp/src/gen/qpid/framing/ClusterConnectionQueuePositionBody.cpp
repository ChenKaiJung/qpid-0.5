...
#include "ClusterConnectionQueuePositionBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void ClusterConnectionQueuePositionBody::setQueue(const string& _queue) {
    queue = _queue;
    flags |= (1 << 8);
}
const string& ClusterConnectionQueuePositionBody::getQueue() const { return queue; }
