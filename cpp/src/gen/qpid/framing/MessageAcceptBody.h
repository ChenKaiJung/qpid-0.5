#ifndef QPID_FRAMING_MESSAGEACCEPTBODY_H
...
class MessageAcceptBody : public ModelMethod {
...
public:
    ...
    MessageAcceptBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.accept(getTransfers());
    }
...
#endif  /*!QPID_FRAMING_MESSAGEACCEPTBODY_H*/
