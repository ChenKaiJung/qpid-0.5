...
#include "ClusterConnectionTxDequeueBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void ClusterConnectionTxDequeueBody::setQueue(const string& _queue) {
    queue = _queue;
    flags |= (1 << 8);
}
const string& ClusterConnectionTxDequeueBody::getQueue() const { return queue; }
