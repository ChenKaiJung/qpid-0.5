...
#include "ClusterConnectionAddQueueListenerBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void ClusterConnectionAddQueueListenerBody::setQueue(const string& _queue) {
    queue = _queue;
    flags |= (1 << 8);
}
const string& ClusterConnectionAddQueueListenerBody::getQueue() const { return queue; }
