#ifndef QPID_FRAMING_EXCHANGEUNBINDBODY_H
#define QPID_FRAMING_EXCHANGEUNBINDBODY_H
/*
 *
...
class ExchangeUnbindBody : public ModelMethod {
    string queue;
    string exchange;
    string bindingKey;
    uint16_t flags;
public:
    ...
    ExchangeUnbindBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.unbind(getQueue(), getExchange(), getBindingKey());
    }
...
#endif  /*!QPID_FRAMING_EXCHANGEUNBINDBODY_H*/
