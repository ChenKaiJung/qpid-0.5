...
#include "MessageCancelBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void MessageCancelBody::setDestination(const string& _destination) {
    destination = _destination;
    flags |= (1 << 8);
}
const string& MessageCancelBody::getDestination() const { return destination; }
