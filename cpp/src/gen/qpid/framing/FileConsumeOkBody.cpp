...
#include "FileConsumeOkBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void FileConsumeOkBody::setConsumerTag(const string& _consumerTag) {
    consumerTag = _consumerTag;
    flags |= (1 << 8);
}
const string& FileConsumeOkBody::getConsumerTag() const { return consumerTag; }
