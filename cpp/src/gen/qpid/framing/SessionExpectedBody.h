...
#define QPID_FRAMING_SESSIONEXPECTEDBODY_H
/*
 *
...
class SessionExpectedBody : public AMQMethodBody {
...
public:
    ...
    SessionExpectedBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
...
virtual uint8_t type() const { return 0;/*control segment*/ }
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.expected(getCommands(), getFragments());
    }
...
#endif  /*!QPID_FRAMING_SESSIONEXPECTEDBODY_H*/
