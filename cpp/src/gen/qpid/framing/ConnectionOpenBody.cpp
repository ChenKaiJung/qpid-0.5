...
#include "ConnectionOpenBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void ConnectionOpenBody::setVirtualHost(const string& _virtualHost) {
    virtualHost = _virtualHost;
    flags |= (1 << 8);
}
const string& ConnectionOpenBody::getVirtualHost() const { return virtualHost; }
