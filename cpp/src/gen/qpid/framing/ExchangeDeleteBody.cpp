...
#include "ExchangeDeleteBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void ExchangeDeleteBody::setExchange(const string& _exchange) {
    exchange = _exchange;
    flags |= (1 << 8);
}
const string& ExchangeDeleteBody::getExchange() const { return exchange; }
