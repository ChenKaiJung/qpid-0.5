#ifndef QPID_FRAMING_FILEACKBODY_H
#define QPID_FRAMING_FILEACKBODY_H
/*
 *
...
class FileAckBody : public ModelMethod {
...
public:
    ...
    FileAckBody(ProtocolVersion=ProtocolVersion())  : deliveryTag(0), flags(0) {}
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.ack(getDeliveryTag(), getMultiple());
    }
...
#endif  /*!QPID_FRAMING_FILEACKBODY_H*/
