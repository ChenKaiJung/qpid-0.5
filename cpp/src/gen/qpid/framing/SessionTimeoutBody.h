...
#define QPID_FRAMING_SESSIONTIMEOUTBODY_H
/*
 *
...
class SessionTimeoutBody : public AMQMethodBody {
    uint32_t timeout;
    uint16_t flags;
public:
    ...
    SessionTimeoutBody(ProtocolVersion=ProtocolVersion())  : timeout(0), flags(0) {}
...
virtual uint8_t type() const { return 0;/*control segment*/ }
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.timeout(getTimeout());
    }
...
#endif  /*!QPID_FRAMING_SESSIONTIMEOUTBODY_H*/
