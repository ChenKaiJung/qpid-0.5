#ifndef QPID_FRAMING_CLUSTERCONNECTIONTXDEQUEUEBODY_H
#define QPID_FRAMING_CLUSTERCONNECTIONTXDEQUEUEBODY_H
/*
 *
...
public:
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.txDequeue(getQueue());
    }
...
#endif  /*!QPID_FRAMING_CLUSTERCONNECTIONTXDEQUEUEBODY_H*/
