...
#include "MessageFlowBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void MessageFlowBody::setDestination(const string& _destination) {
    destination = _destination;
    flags |= (1 << 8);
}
const string& MessageFlowBody::getDestination() const { return destination; }
