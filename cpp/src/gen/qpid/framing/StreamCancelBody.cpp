...
#include "StreamCancelBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void StreamCancelBody::setConsumerTag(const string& _consumerTag) {
    consumerTag = _consumerTag;
    flags |= (1 << 8);
}
const string& StreamCancelBody::getConsumerTag() const { return consumerTag; }
