#ifndef QPID_FRAMING_QUEUEDELETEBODY_H
#define QPID_FRAMING_QUEUEDELETEBODY_H
/*
 *
...
public:
    ...
    bool hasQueue() const;
    void clearQueueFlag();
    void setIfUnused(bool _ifUnused);
    bool getIfUnused() const;
    void setIfEmpty(bool _ifEmpty);
    bool getIfEmpty() const;
    typedef void ResultType;

    template <class T> ResultType invoke(T& invocable) const {
        return invocable.delete_(getQueue(), getIfUnused(), getIfEmpty());
    }
...
#endif  /*!QPID_FRAMING_QUEUEDELETEBODY_H*/
