#ifndef QPID_FRAMING_CLUSTERCONNECTIONTXACCEPTBODY_H
...
class ClusterConnectionTxAcceptBody : public ModelMethod {
    SequenceSet commands;
    uint16_t flags;
public:
    static const ClassId CLASS_ID = 0x81;
    static const MethodId METHOD_ID = 0x13;
    ...
    ClusterConnectionTxAcceptBody(ProtocolVersion=ProtocolVersion())  : flags(0) {}
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.txAccept(getCommands());
    }
