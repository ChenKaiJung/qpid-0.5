...
#include "MessageStopBody.h"

#include "reply_exceptions.h"

using namespace qpid::framing;

void MessageStopBody::setDestination(const string& _destination) {
    destination = _destination;
    flags |= (1 << 8);
}
const string& MessageStopBody::getDestination() const { return destination; }
