...
void AMQP_AllOperations::Invoker::visit(const ClusterMessageExpiredBody& body) {
    AMQP_AllOperations::ClusterHandler::Invoker invoker(*target.getClusterHandler());
    body.accept(invoker);
    result=invoker.getResult();
}
...
void AMQP_AllOperations::Invoker::visit(const ClusterConnectionQueueBody& body) {
    AMQP_AllOperations::ClusterConnectionHandler::Invoker invoker(*target.getClusterConnectionHandler());
    body.accept(invoker);
    result=invoker.getResult();
}
...
void AMQP_AllOperations::ClusterHandler::Invoker::visit(const ClusterMessageExpiredBody& body) {
    body.invoke(target);
    result.handled=true;
}
...
void AMQP_AllOperations::ClusterConnectionHandler::Invoker::visit(const ClusterConnectionQueueBody& body) {
    body.invoke(target);
    result.handled=true;
}
