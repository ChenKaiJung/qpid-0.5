...
void MessageProperties::setCorrelationId(const string& _correlationId) {
    correlationId = _correlationId;
    flags |= (1 << 10);
}
const string& MessageProperties::getCorrelationId() const { return correlationId; }
...
void MessageProperties::setContentType(const string& _contentType) {
    contentType = _contentType;
    flags |= (1 << 12);
}
const string& MessageProperties::getContentType() const { return contentType; }
bool MessageProperties::hasContentType() const { return flags & (1 << 12); }
void MessageProperties::clearContentTypeFlag() { flags &= ~(1 << 12); }

void MessageProperties::setContentEncoding(const string& _contentEncoding) {
    contentEncoding = _contentEncoding;
    flags |= (1 << 13);
}
const string& MessageProperties::getContentEncoding() const { return contentEncoding; }
...
void MessageProperties::setUserId(const string& _userId) {
    userId = _userId;
    flags |= (1 << 14);
}
const string& MessageProperties::getUserId() const { return userId; }
bool MessageProperties::hasUserId() const { return flags & (1 << 14); }
void MessageProperties::clearUserIdFlag() { flags &= ~(1 << 14); }

void MessageProperties::setAppId(const string& _appId) {
    appId = _appId;
    flags |= (1 << 15);
}
const string& MessageProperties::getAppId() const { return appId; }
