...
static const size_t MAX028 = sizeof(cluster::Ready) > MAX027 ? sizeof(cluster::Ready) : MAX027;
static const size_t MAX029 = sizeof(cluster::ConfigChange) > MAX028 ? sizeof(cluster::ConfigChange) : MAX028;
static const size_t MAX030 = sizeof(cluster::MessageExpired) > MAX029 ? sizeof(cluster::MessageExpired) : MAX029;
static const size_t MAX031 = sizeof(cluster::Shutdown) > MAX030 ? sizeof(cluster::Shutdown) : MAX030;
static const size_t MAX032 = sizeof(cluster-connection::DeliverClose) > MAX031 ? sizeof(cluster-connection::DeliverClose) : MAX031;
static const size_t MAX033 = sizeof(cluster-connection::DeliverDoOutput) > MAX032 ? sizeof(cluster-connection::DeliverDoOutput) : MAX032;
static const size_t MAX034 = sizeof(cluster-connection::ConsumerState) > MAX033 ? sizeof(cluster-connection::ConsumerState) : MAX033;
static const size_t MAX035 = sizeof(cluster-connection::DeliveryRecord) > MAX034 ? sizeof(cluster-connection::DeliveryRecord) : MAX034;
static const size_t MAX036 = sizeof(cluster-connection::TxStart) > MAX035 ? sizeof(cluster-connection::TxStart) : MAX035;
static const size_t MAX037 = sizeof(cluster-connection::TxAccept) > MAX036 ? sizeof(cluster-connection::TxAccept) : MAX036;
static const size_t MAX038 = sizeof(cluster-connection::TxDequeue) > MAX037 ? sizeof(cluster-connection::TxDequeue) : MAX037;
static const size_t MAX039 = sizeof(cluster-connection::TxEnqueue) > MAX038 ? sizeof(cluster-connection::TxEnqueue) : MAX038;
static const size_t MAX040 = sizeof(cluster-connection::TxPublish) > MAX039 ? sizeof(cluster-connection::TxPublish) : MAX039;
static const size_t MAX041 = sizeof(cluster-connection::TxEnd) > MAX040 ? sizeof(cluster-connection::TxEnd) : MAX040;
static const size_t MAX042 = sizeof(cluster-connection::AccumulatedAck) > MAX041 ? sizeof(cluster-connection::AccumulatedAck) : MAX041;
static const size_t MAX043 = sizeof(cluster-connection::SessionState) > MAX042 ? sizeof(cluster-connection::SessionState) : MAX042;
static const size_t MAX044 = sizeof(cluster-connection::ShadowReady) > MAX043 ? sizeof(cluster-connection::ShadowReady) : MAX043;
static const size_t MAX045 = sizeof(cluster-connection::Membership) > MAX044 ? sizeof(cluster-connection::Membership) : MAX044;
static const size_t MAX046 = sizeof(cluster-connection::QueuePosition) > MAX045 ? sizeof(cluster-connection::QueuePosition) : MAX045;
static const size_t MAX047 = sizeof(cluster-connection::Exchange) > MAX046 ? sizeof(cluster-connection::Exchange) : MAX046;
static const size_t MAX048 = sizeof(cluster-connection::Queue) > MAX047 ? sizeof(cluster-connection::Queue) : MAX047;
static const size_t MAX049 = sizeof(cluster-connection::ExpiryId) > MAX048 ? sizeof(cluster-connection::ExpiryId) : MAX048;
static const int MAX=MAX049;
