    ...
    public SessionBase_0_10
{
  public:
     ...
     * 
     */
    void executionResult(const SequenceNumber& commandId=SequenceNumber(), const string& value=string(), bool sync=true);
     ...
     * 
     */
    void executionException(uint16_t errorCode=0, const SequenceNumber& commandId=SequenceNumber(), uint8_t classCode=0, uint8_t commandCode=0, uint8_t fieldIndex=0, const string& description=string(), const FieldTable& errorInfo=FieldTable(), bool sync=true);
     ...
     * 
     */
    void messageTransfer(const string& destination=string(), uint8_t acceptMode=1, uint8_t acquireMode=0, const MethodContent& content=DefaultContent(std::string()), bool sync=true);
     ...
     * 
     */
    void messageReject(const SequenceSet& transfers=SequenceSet(), uint16_t code=0, const string& text=string(), bool sync=true);
     ...
     * 
     */
    qpid::framing::MessageResumeResult messageResume(const string& destination=string(), const string& resumeId=string(), bool sync=true);
     ...
     * 
     */
    void messageSubscribe(const string& queue=string(), const string& destination=string(), uint8_t acceptMode=0, uint8_t acquireMode=0, bool exclusive=false, const string& resumeId=string(), uint64_t resumeTtl=0, const FieldTable& arguments=FieldTable(), bool sync=true);
     ...
     * 
     */
    void messageCancel(const string& destination=string(), bool sync=true);
     ...
     * 
     */
    void messageSetFlowMode(const string& destination=string(), uint8_t flowMode=0, bool sync=true);
     ...
     * 
     */
    void messageFlow(const string& destination=string(), uint8_t unit=0, uint32_t value=0, bool sync=true);
     ...
     * 
     */
    void messageFlush(const string& destination=string(), bool sync=true);
     ...
     * 
     */
    void messageStop(const string& destination=string(), bool sync=true);
     ...
     * 
     */
    void exchangeDeclare(const string& exchange=string(), const string& type=string(), const string& alternateExchange=string(), bool passive=false, bool durable=false, bool autoDelete=false, const FieldTable& arguments=FieldTable(), bool sync=true);
     ...
     * 
     */
    void exchangeDelete(const string& exchange=string(), bool ifUnused=false, bool sync=true);
     ...
     * 
     */
    qpid::framing::ExchangeQueryResult exchangeQuery(const string& name=string(), bool sync=true);
     ...
     * 
     */
    void exchangeBind(const string& queue=string(), const string& exchange=string(), const string& bindingKey=string(), const FieldTable& arguments=FieldTable(), bool sync=true);
     ...
     * 
     */
    void exchangeUnbind(const string& queue=string(), const string& exchange=string(), const string& bindingKey=string(), bool sync=true);
     ...
     * 
     */
    qpid::framing::ExchangeBoundResult exchangeBound(const string& exchange=string(), const string& queue=string(), const string& bindingKey=string(), const FieldTable& arguments=FieldTable(), bool sync=true);
     ...
     * 
     */
    void queueDeclare(const string& queue=string(), const string& alternateExchange=string(), bool passive=false, bool durable=false, bool exclusive=false, bool autoDelete=false, const FieldTable& arguments=FieldTable(), bool sync=true);
     ...
     * 
     */
    void queueDelete(const string& queue=string(), bool ifUnused=false, bool ifEmpty=false, bool sync=true);
     ...
     * 
     */
    void queuePurge(const string& queue=string(), bool sync=true);
     ...
     * 
     */
    qpid::framing::QueueQueryResult queueQuery(const string& queue=string(), bool sync=true);
};
